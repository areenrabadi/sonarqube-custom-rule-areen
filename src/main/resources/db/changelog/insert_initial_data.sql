...
INSERT INTO TYPES (ID, CODE, DESCRIPTION, NAME, CREATED_AT)
VALUES (1, 'BANK_INFO', '', 'Bank Information', CURRENT_TIMESTAMP);

-- Inserting values into the EXTENSIONS table
INSERT INTO EXTENSIONS (ID, CODE, DESCRIPTION, NAME, CREATED_AT)
VALUES (1, 'image/png', '', 'PNG Image', CURRENT_TIMESTAMP);

INSERT INTO EXTENSIONS (ID, CODE, DESCRIPTION, NAME, CREATED_AT)
VALUES (2, 'application/pdf', '', 'PDF File', CURRENT_TIMESTAMP);
